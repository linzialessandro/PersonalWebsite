        ...
        <div className="document-content text-left">
          <div style={{ marginBottom: "2rem" }}>
            ...
            <p style={{ color: "var(--text-primary)", marginBottom: "1.5rem" }}>
              ...
              interactive AI-powered conversational interface. Ask questions
              about my research in Valuation Theory, my academic journey, or my
              teaching experience.
            </p>
          ...
          <div>
            ...
            <div className="resource-card">
              ...
              >
                ...
                <div>
                  ...
                  >
                    Detailed Curriculum Vitae (PDF format)
                  </p>
                </div>
              </div>
              <a
            ...
            <div style={{ marginTop: "2rem", textAlign: "left" }}>
              ...
              >
                You can download my full CV using the button above. The document
                contains comprehensive details regarding my:
              </p>
              <ul
                style={{
