  ...
  return (
    <div className="container mx-auto px-6 pt-12 pb-24 md:pt-20">
      ...
      >
        ...
        <motion.div
          className="lg:col-span-5 flex flex-col justify-center h-full pt-4"
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <Link
              to="/publications"
              className="group inline-flex items-center justify-center px-6 py-3 font-mono text-sm font-medium text-foreground border border-border rounded-lg transition-all hover:border-accent hover:text-accent hover:bg-accent/5"
            >
              Publications{" "}
              <ChevronRight
                size={16}
        ...
        <motion.div className="lg:col-span-7" variants={itemVariants}>
          <TerminalWindow title="cat profile.txt" delay={300}>
            <div className="flex flex-col gap-4 text-muted-foreground">
              <p>
                <span className="text-accent-cyan font-bold"># EXPERTISE</span>
                <br />
                My doctoral research established novel connections across the
                model theory of valued fields and algebraic hyperstructures
                (hyperfields, polygroups). This work led to publications in
                leading journals such as Journal of Algebra and Israel Journal
                of Mathematics.
              </p>
              <p>
                ...
                <br />
                My expertise extends to constructive logic, proof theory, and
                category theory. I am deeply interested in the computational
                interpretation of logical principles, particularly the
                Curry–Howard correspondence. I view logic as a bridge connecting
                foundational mathematics, AI theory, and quantum logic.
              </p>
              <p>
                <span className="text-accent-cyan font-bold">
                  # ACADEMIC_EXPERIENCE
                ...
                <br />
                Alongside research, I have substantial teaching experience at
                the university level. I actively contribute to collaborative
                projects and mentor graduate students to foster the next
                generation of mathematical logicians.
              </p>
      ...
      >
        <div className="relative p-8 md:p-12 rounded-2xl bg-secondary/20 border border-border/40 backdrop-blur-sm">
          <div className="absolute -top-6 -left-2 text-6xl text-accent/20 font-serif leading-none">
            "
          </div>
          <p className="text-sm md:text-[0.95rem] font-body text-muted-foreground leading-relaxed italic mb-6">
            [...] 1+1=2
            <br />
            Dem. [...]
            <br />
            The above proposition is occasionally useful. It is used at least
            three times, [...]
          </p>
